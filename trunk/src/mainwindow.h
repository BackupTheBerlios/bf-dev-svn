...
public:
    ...
    QTextEdit *compilerTextEdit;
    QWidget *debuggerTab;
    QVBoxLayout *vboxLayout2;
    QTextEdit *debuggerTextEdit;
    QWidget *interpreterTab;
    QVBoxLayout *vboxLayout3;
    QTextEdit *interpreterTextEdit;
    QMenuBar *menubar;
    QMenu *menuHelp;
    QMenu *menuWindow;
    QMenu *menuEdit;
    ...
    sizePolicy.setHeightForWidth(codeTextEdit->sizePolicy().hasHeightForWidth());
    codeTextEdit->setSizePolicy(sizePolicy);

    vboxLayout->addWidget(codeTextEdit);
    ...
    compilerTextEdit = new QTextEdit(compilerTab);
    compilerTextEdit->setObjectName(QString::fromUtf8("compilerTextEdit"));
    compilerTextEdit->setReadOnly(true);

    vboxLayout1->addWidget(compilerTextEdit);
    ...
    debuggerTextEdit = new QTextEdit(debuggerTab);
    debuggerTextEdit->setObjectName(QString::fromUtf8("debuggerTextEdit"));
    debuggerTextEdit->setReadOnly(true);

    vboxLayout2->addWidget(debuggerTextEdit);
    ...
    interpreterTextEdit = new QTextEdit(interpreterTab);
    interpreterTextEdit->setObjectName(QString::fromUtf8("interpreterTextEdit"));
    interpreterTextEdit->setReadOnly(true);

    vboxLayout3->addWidget(interpreterTextEdit);
    ...
    develTabWidget->setCurrentIndex(0);
